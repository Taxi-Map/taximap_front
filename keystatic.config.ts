		...
		settings: singleton({
			...
			schema: {
				languages: fields.array(
					fields.object({
						code: fields.text({
							label: "Código do Idioma (ex: pt, en)",
						}),
					...
					}),
					{
						...
						itemLabel: (props) =>
							props.fields.label.value || "Novo Idioma",
					},
				),
				topHeader: fields.object({
					leftLinks: fields.array(
						...
						{
							label: "Links da Esquerda",
							itemLabel: (props) =>
								props.fields.label.value || "Link",
						},
					),
					rightLinks: fields.array(
						...
						{
							label: "Links da Direita (ex: Apoio ao Cliente)",
							itemLabel: (props) =>
								props.fields.label.value || "Link",
						},
					),
